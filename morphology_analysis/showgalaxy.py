...
def showgalaxy(axi,snapkey,subfindID,camera,filters=['NC-F115W','NC-F150W','NC-F200W'],alph=0.2,Q=8.0,Npix=400,ckpc=None,ckpcz=None,sb='SB25',rfkey=None,dx=0,dy=0,invert=False):
